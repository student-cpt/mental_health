  ...
  return (
    <div className="about-section">
      ...
      <div className="values-grid">
        {[
          { title: 'Passion', text: 'Passion is the spark that ignites creativity and fuels persistence. It’s the unwavering enthusiasm and commitment to pursuing what truly matters to you, even in the face of challenges. Passion drives you to pour your energy and heart into every detail, transforming ordinary efforts into extraordinary results. It is what makes hard work feel fulfilling and turns aspirations into achievements. Whether it’s a personal interest or a professional goal, passion gives life purpose and meaning, inspiring others along the way.' },
          { title: 'Community', text: 'Community is the cornerstone of connection, where individuals come together to share, support, and grow. It fosters a sense of belonging and unity, built on shared values, interests, or goals. A strong community thrives on collaboration, where every member contributes their unique perspectives and skills, creating a vibrant and inclusive environment. It is in communities that people find encouragement during challenges, celebrate achievements, and inspire collective action. Ultimately, a community is more than just a group—it’s a bond that uplifts, empowers, and nurtures its members, shaping a brighter and stronger future together.'},
          { title: 'Commitment', text: 'Commitment is the foundation of success, reflecting dedication and perseverance in achieving goals. It’s about staying true to your promises and putting in consistent effort, even when challenges arise.' },
          { title: 'Growth', text: 'Growth is a journey of continuous learning and self-improvement, where every experience, whether success or failure, becomes an opportunity to evolve and become better. It’s about embracing change and striving to reach your fullest potential.' },
          { title: 'Honesty', text: 'Honesty builds trust and authenticity, fostering open communication and respect. Being honest with yourself and others creates a strong foundation for meaningful relationships and ethical decision-making.' },
          { title: 'Team Work', text: 'Teamwork is the power of collaboration, where diverse talents come together to achieve a common vision. It thrives on mutual respect, shared responsibility, and collective effort, demonstrating that we can accomplish far more together than we ever could alone.Together, these values create a roadmap for personal and collective success, inspiring integrity, resilience, and unity.' }
        ].map((value, index) => (
      ...
      <div className="process-container">
        ...
        <div className="process-steps">
          {[
            { icon: <FaCalendarCheck size={40} color="#007bff" />, title: 'Appointment'},
            { icon: <FaComments size={40} color="#007bff" />, title: 'Consultation' },
            { icon: <FaHandsHelping size={40} color="#007bff" />, title: 'Support' },
            { icon: <FaHandsHelping size={40} color="#007bff" />, title: 'Support'  },
            { icon: <FaHandsHelping size={40} color="#007bff" />, title: 'Support'  },
            { icon: <FaCheckCircle size={40} color="#007bff" />, title: 'Result' }
          ].map((step, index) => (
