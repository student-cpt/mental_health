  ...
  return (
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
        <div class="mx-auto mb-8 max-w-screen-sm lg:mb-16">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Mental Health</h2>
            <p class="font-light text-gray-500 sm:text-xl dark:text-gray-400">Read about some mental health related topics</p>
        </div> 
